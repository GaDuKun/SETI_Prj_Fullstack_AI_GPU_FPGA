...
#ifndef TENSORFLOW_LITE_UTIL_MODELLITE_DATA_H_
#define TENSORFLOW_LITE_UTIL_MODELLITE_DATA_H_

extern const unsigned char modelLite[];
extern const int modelLite_len;

#endif  // TENSORFLOW_LITE_UTIL_MODELLITE_DATA_H_
